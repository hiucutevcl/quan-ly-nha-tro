  ...
  return (
    <>
        <div 
            ...
            className="relative overflow-hidden rounded-2xl shadow-lg p-6 bg-gradient-to-br from-rose-500 to-orange-500 text-white my-6 group cursor-pointer transition-transform hover:-translate-y-1"
        >
        ...
        {showModal && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-opacity" onClick={() => setShowModal(false)}>
                <div 
                ...
                >
                    ...
                    {/* Content */}
                    <div className="p-6">
                        <h2 className="text-2xl font-black text-gray-800 mb-3 leading-tight">{ad.title}</h2>
                        ...
                        <div className="text-gray-700 text-sm leading-relaxed mb-8 whitespace-pre-wrap border-l-4 border-gray-200 pl-4">
                            {ad.details || 'Đang cập nhật thông tin chi tiết quảng cáo...'}
                        </div>
