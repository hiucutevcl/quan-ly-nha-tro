...
const { createInvoice, getMyInvoices, getRooms, payInvoice, getAllInvoices, getMeterHistory, remindInvoice } = require('../controllers/invoiceController');
...
router.put('/remind/:id', verifyToken, checkAdmin, remindInvoice);
