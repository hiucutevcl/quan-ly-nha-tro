...
const getPublicSettings = async (req, res) => {
    try {
        ...
        const publicKeys = ['nha_tro_name', 'address', 'phone', 'note', 'owner', 'elec_price', 'water_price', 'quick_replies', 'ads_config', 'custom_quick_replies', 'buildings_list', 'hero_image', 'logo_image'];
